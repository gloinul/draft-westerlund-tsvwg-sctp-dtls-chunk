...
DTLS Chunk is OPTIONAL, and negotiated using the DTLS Key Management Method.
...
* DTLS Connection ID: : If DTLS connection ID (CID) has been negotiated by
  the DTLS Key Management Method its field length and value are include. The field length
