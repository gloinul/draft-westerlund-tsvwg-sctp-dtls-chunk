...
connection is available.  The implementors SHOULD guarantee that new a
replacement traffic DTLS connection as well as a new Restart DCI are
handshaked as soon as possible so that the time when no Restart DCI
are available is kept to a minimum.
